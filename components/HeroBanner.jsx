  ...
  return (
    <div className='relative text-white text-[20px] w-full max-w-[1360px] mx-auto'>
        <Carousel autoPlay={true} 
                ...
                <div>
                    <img src="/slide1.png" className='aspect-[20/10] md:aspect-auto'/>
                    <div className='px-[15px] md:px-[40px] py-[10px] md: py-[25px] font-oswald
                        ...
                        md:text-[30px] uppercase font-medium cursor-pointer hover:opacity-90'> SHOP NOW</div>
                </div>

                <div>
                    <img src="/slide2.png" className='aspect-[20/10] md:aspect-auto'/>
                    <div className='px-[15px] md:px-[40px] py-[10px] md: py-[25px] font-oswald
                        bg-white absolute bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9] text-[15px]
                        md:text-[30px] uppercase font-medium cursor-pointer hover:opacity-90'> SHOP NOW</div>
                </div>
                ...
                <div>
                    <img src="/slide3.png" className='aspect-[20/10] md:aspect-auto'/>
                    <div className='px-[15px] md:px-[40px] py-[10px] md: py-[25px] font-oswald
                        bg-white absolute bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9] text-[15px]
                        md:text-[30px] uppercase font-medium cursor-pointer hover:opacity-90'> SHOP NOW</div>
                </div>
